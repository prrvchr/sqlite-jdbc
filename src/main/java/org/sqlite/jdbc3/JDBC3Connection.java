...
public abstract class JDBC3Connection extends SQLiteConnection {
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        if (autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS && QueryUtils.isInsertQuery(sql, "*")) {
    ...
    public PreparedStatement prepareStatement(String sql, String[] cols) throws SQLException {
        PreparedStatement statement;
        if (QueryUtils.isInsertQuery(sql, cols)) {
            statement = prepareStatement(
                    sql,
                    ResultSet.TYPE_FORWARD_ONLY,
                    ResultSet.CONCUR_READ_ONLY,
    ...
    protected abstract PreparedStatement prepareStatement(String sql, int rst, int rsc, int rsh, String... cols)
            throws SQLException;
